...
contract ERC20 {
    ...
    uint8 [...] decimals;                             //How many decimals to show for this token
    string [...] symbol;                              //This token's identifier
    uint256 [...] totalSupply;                        //all the tokens the smart contract contains
    ...
    constructor(uint256 _initialAmount, string memory _tokenName, uint8 _decimalUnits, string memory _tokenSymbol) public {
        balances[...] = [...];                          // Give the creator all initial tokens
